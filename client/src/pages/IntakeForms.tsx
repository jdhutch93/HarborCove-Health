...
export default function IntakeForms() {
  return (
    <div className="min-h-screen bg-white font-['Nunito_Sans']">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-12">
            <div className="flex items-center gap-3 mb-6">
              <div className="w-1 h-8 bg-[#2E8B6E] rounded-full" />
              <h2 className="font-['Lora'] font-700 text-[#1B5E4B] text-2xl">Ketamine Therapy Forms</h2>
            </div>
            <div className="grid md:grid-cols-2 gap-6">
              {forms.filter(f => f.category === "Ketamine Therapy").map((form) => {
                const Icon = form.icon;
                return (
                  <div key={form.id} className="bg-white rounded-xl shadow-sm border border-[#D4E8DF] overflow-hidden flex flex-col">
                    <div className="bg-[#1B5E4B] px-6 py-4 flex items-center gap-3">
                      <div className="w-9 h-9 rounded-full bg-white/15 flex items-center justify-center flex-shrink-0">
                        <Icon className="w-4 h-4 text-white" />
                      </div>
                      <div>
                        <p className="text-[#7EC8A4] text-xs font-['Nunito_Sans'] font-700 tracking-widest uppercase">{form.category}</p>
                    ...
                    <div className="p-6 flex flex-col flex-1">
                      ...
                      <a
                        ...
                        className="inline-flex items-center justify-center gap-2 w-full px-5 py-3.5 bg-[#1B5E4B] hover:bg-[#174f3e] text-white font-['Nunito_Sans'] font-700 text-sm rounded transition-colors"
                      >
          ...
          <div>
            <div className="flex items-center gap-3 mb-6">
              <div className="w-1 h-8 bg-[#2E8B6E] rounded-full" />
              <h2 className="font-['Lora'] font-700 text-[#1B5E4B] text-2xl">Weight Management Forms</h2>
            </div>
            <div className="grid md:grid-cols-2 gap-6">
              {forms.filter(f => f.category === "Weight Management").map((form) => {
                ...
                return (
                  <div key={form.id} className="bg-white rounded-xl shadow-sm border border-[#D4E8DF] overflow-hidden flex flex-col">
                    <div className="bg-[#2E8B6E] px-6 py-4 flex items-center gap-3">
                      <div className="w-9 h-9 rounded-full bg-white/15 flex items-center justify-center flex-shrink-0">
                        <Icon className="w-4 h-4 text-white" />
                      </div>
                      <div>
                    ...
                    <div className="p-6 flex flex-col flex-1">
                      ...
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="inline-flex items-center justify-center gap-2 w-full px-5 py-3.5 bg-[#2E8B6E] hover:bg-[#267A60] text-white font-['Nunito_Sans'] font-700 text-sm rounded transition-colors"
                      >
                        {form.cta} <ArrowRight className="w-4 h-4" />
                      </a>
                    </div>
      ...
      <section className="py-12 bg-white border-t border-[#D4E8DF]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 px-6 py-3 bg-[#1B5E4B] hover:bg-[#174f3e] text-white font-['Nunito_Sans'] font-700 text-sm rounded transition-colors"
          >
